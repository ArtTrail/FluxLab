...
public static class StarCentroid
{
    ...
    /// </summary>
    public static Result? TryCentroid(float[] pixels, int width, int height, double seedX, double seedY)
    {
        ...
        // Safeguard: don't trust the radial-profile FWHM measurement below this SNR -- use a
        // fixed, modest default radius instead. See MinSnrForReliableFwhm's comment.
